    ...
    <div className='py-8'>
      <div className='container'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8'>
          <div className='py-10 pl-5 bg-gradient-to-br from-black/90 overflow-hidden
           to-black/70 text-white rounded-3xl relative h-[320px] flex items-end'>
            ...
            <img src={Image1} alt='' className='w-[320px] h-[320px] absolute top-0 left-16 hover:scale-105 duration-500' />
          </div>
          ...
          <div className='py-10 pl-5 bg-gradient-to-br from-black/90 overflow-hidden
           to-[#bc6c25]/70 text-white rounded-3xl relative h-[320px] flex items-end'>
            ...
            <img src={Image2} alt='' className='w-[320px] h-[320px] absolute top-0 left-16 hover:scale-105 duration-500' />
          </div>

          <div className='col-span-2 py-10 pl-5 bg-gradient-to-br from-black/90 overflow-hidden
           to-[#bc6c25]/40 text-white rounded-3xl relative h-[320px] flex items-end'>
            ...
            <img src={Image4} alt='' className='w-[320px] h-[320px] absolute top-0 right-0 hover:scale-105 duration-500' />
          </div>
          ...
          <div className='col-span-2 py-10 pl-5 bg-gradient-to-br from-black/90 overflow-hidden
           to-[#bc6c25]/90 text-white rounded-3xl relative h-[320px] flex items-end'>
            ...
            <img src={Image5} alt='' className='w-[320px] h-[320px] absolute top-0 right-0 hover:scale-105 duration-500' />
          </div>

          <div className='py-10 pl-5 bg-gradient-to-br from-black/90 overflow-hidden
           to-[#bc6c25]/20 text-white rounded-2xl relative h-[320px] flex items-end'>
            <div>
              <div className='mb-4'>
            ...
            <img src={Image2} alt='' className='w-[320px] h-[320px] absolute top-0 left-14 hover:scale-105 duration-500' />
          </div>

          <div className='py-10 pl-5 bg-gradient-to-br from-black/90 overflow-hidden
           to-[#bc6c25]/70 text-white rounded-2xl relative h-[320px] flex items-end'>
            <div>
              <div className='mb-4'>
                <p className='mb-[2px] text-gray-400'>Tailored Perfect</p>
                <p className='text-2xl font-bold mb-[2px]'>Stylish</p>
                <p className='text-3xl xl:text-2xl font-bold opacity-20'>Refined Style</p>
                <button className='bg-[#bc6c25] text-white px-3 py-1 mt-4 rounded-full text-sm' onClick={()=>addCart()}>Explore</button>
              </div>
            </div>
            <img src={Image3} alt='' className='w-[320px] h-[320px] absolute top-0 left-14 hover:scale-105 duration-500' />
          </div>
        </div>
      </div>
    </div>
